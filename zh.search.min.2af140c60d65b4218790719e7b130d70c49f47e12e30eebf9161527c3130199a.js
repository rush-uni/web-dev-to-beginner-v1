...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/web-dev-to-beginner-v1/flexsearch.min.js');loadScript('/web-dev-to-beginner-v1/zh.search-data.min.3bb076de5ed95ee5e15db23562d4b9140acb4c837db330c7ccd7e1889926da2f.js',function(){input.required=false;search();});}
