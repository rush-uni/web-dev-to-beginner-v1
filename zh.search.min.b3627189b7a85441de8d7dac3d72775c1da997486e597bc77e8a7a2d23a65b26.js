...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/web-dev-to-beginner-v1/flexsearch.min.js');loadScript('/web-dev-to-beginner-v1/zh.search-data.min.4ec2e0a1e15a80573d1544d9bb0920e5a23ac0432b2f9a65c9ad962641b43681.js',function(){input.required=false;search();});}
